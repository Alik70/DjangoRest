...
class GameCategoryTests(APITestCase):
    ...
    def test_create_and_retrieve_game_category(self):
        """ creating and retrieving a new game category"""
    ...
    def test_filter_game_category_by_name(self):
        """ensuring the filtering by name works"""
...
class PlayerTests(APITestCase):
    ...
    def test_create_retrieve_player(self):
        """ checking creation and retrieving of a new player"""
    ...
    def test_retrieve_player_list(self):
        """testing for retrieving a player"""
        new_player_name = 'New Female Player'
        new_player_gender = Player.FEMALE
        self.create_player(name=new_player_name, gender=new_player_gender)
        url = reverse('player-list')
        response = self.client.get(url, format='json')
        self.assertEqual(
            response.status_code,
